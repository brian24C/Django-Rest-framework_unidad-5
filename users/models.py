...
class User(AbstractUser):
    ...
    USERNAME_FIELD = "email"          #los usuarios podrán iniciar sesión con su dirección de correo electrónico
    REQUIRED_FIELDS = ["username"]  #se querirá ese campo para crear un usuario
